# Julia and Nicole's Countdown timer
import platform
# to retrieve as much possible information about the platform on which the program is being currently execute

try:
    import Tkinter as tk
except ImportError:
    import tkinter as tk
# we used Tkinter instead of Kivy because it is not as confusing. Tkinter is the standard GUI library for Python.
# Python when combined with Tkinter provides a fast and easy way to create GUI applications.
# Tkinter provides a powerful object-oriented interface to the Tk GUI toolkit.

# Appearance, how the timer will look like
FONT_NAME = 'Roboto'
# this font looks pretty
...
# from tkinter this is to scroll or edit the time inputted
